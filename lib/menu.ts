...
export const MENU: MenuItem[] = [
  ...
  { id: "set-dosa",                 no: 66, name: "Set Dosa",                  description: "Two thin butter pan cakes served with mashed potato and green peas curry.", price: 13.99, cookMinutes: DOSA_COOK, category: "dosa", hasMasalaFilling: true },
